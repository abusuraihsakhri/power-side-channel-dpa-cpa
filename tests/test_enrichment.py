"""
Automated Pytest for power-side-channel-dpa-cpa Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    CountermeasureTestingEngine,
    NistComplianceEngine,
    ProductionDeploymentReadinessEngine,
    PowersidechanneldpacpaEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = PowersidechanneldpacpaEnrichmentSuite()
