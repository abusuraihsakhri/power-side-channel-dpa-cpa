"""
Data Models & Telemetry Definitions for Correlation Power Analysis (CPA) & DPA Side-Channel Attack Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "ISO/IEC 17825 Side-Channel Testing"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
