"""
FastAPI REST API Server for Correlation Power Analysis (CPA) & DPA Side-Channel Attack Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="Correlation Power Analysis (CPA) & DPA Side-Channel Attack Agent",
            description="Evaluates Hamming weight/distance power leakage models across AES S-Box rounds, calculating Pearson correlation coefficients.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "power-side-channel-dpa-cpa", "domain": "Hardware Security", "version": "2.0.0-FRONTIER"}
